...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        return function (t, e, i, n) {
            ...
            function s(t, e) {
                var i = t;
                return f.isString(t) ? m.Easings[t] || (i = !1) : i = f.isArray(t) && 1 === t.length ? function (t) {
                    return function (e) {
                                    ...
                                    for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility), k)
                                        if ("element" !== M) {
                                            ...
                                            if (1 === v) P = A.endValue;
                                                ...
                                                if (P = A.startValue + I * T(v, c, I), !p && P === A.currentValue) continue
                                            }
                ...
                var y = m.CSS = {
                    ...
                    Names: {
                        ...
                        SVGAttribute: function (t) {
                            ...
                            return (c || m.State.isAndroid && !m.State.isChrome) && (e += "|transform"), new RegExp("^(" + e + ")$", "i").test(t)
                        },
                ...
                var x = function () {
                    ...
                    function o() {
                        function t(t) {
                            ...
                            function g() {
                                ...
                                if (a && n) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;
                                    ...
                                    m.init(u), t.myParent.appendChild(u), d.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                            ...
                            if ("scroll" === P) {
                                ...
                                u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container, M = (x = u.container["scroll" + T]) + d(o).position()[T.toLowerCase()] + I) : u.container = null : (x = m.State.scrollAnchor[m.State["scrollProperty" + T]], k = m.State.scrollAnchor[m.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], M = d(o).offset()[T.toLowerCase()] + I), c = {
                                    ...
                                    element: o
                                }, m.debug && console.log("tweensContainer (scroll): ", c.scroll, o)
                            } else if ("reverse" === P) {
                                ...
                                for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (D = r(o).tweensContainer), d.each(b, function (t, e) {
                                    ...
                                    if (r(o).isSVG || "tween" === W || !1 !== y.Names.prefixCheck(W)[1] || y.Normalizations.registered[W] !== n) {
                                        ...
                                        if (B = (H = p(O, B))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e, ""
                                            }), j = H[1], B = parseFloat(B) || 0, z = parseFloat(z) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (z /= 100, j = "em") : /^scale/.test(O) ? (z /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y)) j = q;
                                        else if (q !== j && 0 !== B)
                                            if (0 === z) j = q;
                                            else {
                                                a = a || g();
                                        ...
                                        c[O] = {
                                            ...
                                            unitType: j,
                                            easing: N
                                        }, m.debug && console.log("tweensContainer (" + O + "): " + JSON.stringify(c[O]), o)
                        ...
                        var a, o = this,
                            ...
                            c = {};
                        switch (r(o) === n && m.init(o), parseFloat(u.delay) && !1 !== u.queue && d.queue(o, u.queue, function (t) {
                            m.velocityQueueEntryFlag = !0, r(o).delayTimer = {
                    ...
                    if (f.isWrapped(this) ? (c = !1, p = 0, v = this, h = this) : (c = !0, p = 1, v = k ? arguments[0].elements || arguments[0].e : arguments[0]), v = a(v)) {
                        ...
                        switch (c && m.Promise && (A.promise = new m.Promise(function (t, e) {
                            ...
                            case "stop":
                                ...
                                return d.each(m.State.calls, function (t, e) {
                                    e && d.each(e[1], function (i, a) {
                                        var o = w === n ? "" : w;
                                        return !0 !== o && e[2].queue !== o && (w !== n || !1 !== e[2].queue) || void d.each(v, function (i, n) {
                                ...
                                if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                                    if (f.isString(b) && m.Redirects[b]) {
                                        var I = (O = d.extend({}, w)).duration,
                                            D = O.delay || 0;
                                        return !0 === O.backwards && (v = d.extend(!0, [], v).reverse()), d.each(v, function (t, e) {
                                            parseFloat(O.stagger) ? O.delay = D + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = D + O.stagger.call(e, t, S)), O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(b) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / S : (t + 1) / S), .75 * O.duration, 200)), m.Redirects[b].call(e, e, O || {}, t, S, v, A.promise ? A : n)
                                        }), t()
                                    }
                        ...
                        if (d.each(v, function (t, e) {
                                f.isNode(e) && o.call(e)
                            }), (O = d.extend({}, m.defaults, w)).loop = parseInt(O.loop), F = 2 * O.loop - 1, O.loop)
                            for (var V = 0; F > V; V++) {
                                var z = {
                                    delay: O.delay,
                                    progress: O.progress
                    ...
                    t.controllers.bar = t.DatasetController.extend({
                        ...
                        calculateBarIndexPixels: function (t, e, i) {
                            var n, a, o, s, l, u = i.scale.options,
                                ...
                                p = i.start,
                                g = i.end;
                            return 1 === f ? (n = h > p ? h - p : g - h, a = h < g ? g - h : h - p) : (e > 0 && (n = (h - c[e - 1]) / 2, e === f - 1 && (a = n)), e < f - 1 && (a = (c[e + 1] - h) / 2, 0 === e && (n = a))), l = (s = ((o = n * u.categoryPercentage) + a * u.categoryPercentage) / i.stackCount) * u.barPercentage, h -= o, h += s * d, {
                        ...
                        update: function (t) {
                            ...
                            if (f < 2 * Math.PI) {
                                var p = a.rotation % (2 * Math.PI),
                                    ...
                                    C = {
                                        x: b ? 1 : Math.max(v.x * (v.x > 0 ? 1 : k), m.x * (m.x > 0 ? 1 : k)),
                                        y: y ? 1 : Math.max(v.y * (v.y > 0 ? 1 : k), m.y * (m.y > 0 ? 1 : k))
                                    },
                                    M = {
                                        width: .5 * (C.x - S.x),
                                        height: .5 * (C.y - S.y)
                    ...
                    t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                        ...
                        update: function (t) {
                            ...
                            if (t && "object" == typeof t || (t = {
                                    duration: t,
                                    lazy: arguments[1]
                                }), (n = (i = r).options).scale ? i.scale.options = n.scale : n.scales && n.scales.xAxes.concat(n.scales.yAxes).forEach(function (t) {
                                    i.scales[t.id].options = t
                                }), i.tooltip._options = n.tooltips, !1 !== e.notify(r, "beforeUpdate")) {
                        ...
                        bindEvents: function () {
                            ...
                            a.each(t.options.events, function (n) {
                                o.addEventListener(t, n, i), e[n] = i
                            }), t.options.responsive && (i = function () {
                                t.resize()
                            }, o.addEventListener(t, "resize", i), e.resize = i)
                        },
                        unbindEvents: function () {
                            var t = this,
                                e = t._listeners;
                            e && (delete t._listeners, a.each(e, function (e, i) {
                                o.removeEventListener(t, i, e)
                            }))
                        },
                        ...
                        update: function (t, a, r) {
                            if (t) {
                                ...
                                n.each(h.concat(f, p, g), function (t) {
                                    ...
                                    i ? (e = t.update(t.fullWidth ? m : k, w), S -= e.height) : (e = t.update(x, y), k -= e.width), C.push({
                                        horizontal: i,
                                        minSize: e,
                                        box: t
                                    })
                                ...
                                }), I = l, D = u, _ = d, F = c, n.each(h, function (t) {
                                    I += t.width
                                }), n.each(f, function (t) {
                                    D += t.width
                                }), n.each(p, function (t) {
                            ...
                            function W(t) {
                                t.isHorizontal() ? (t.left = t.fullWidth ? l : I, t.right = t.fullWidth ? a - u : I + k, t.top = N, t.bottom = N + t.height, N = t.bottom) : (t.left = z, t.right = z + t.width, t.top = _, t.bottom = _ + S, z = t.right)
                            }
                        }
                    }
                }
                        ...
                        descriptors: function (t) {
                            ...
                            return this._plugins.concat(o.plugins || []).forEach(function (t) {
                                if (-1 === i.indexOf(t)) {
                                    var e = t.id,
                                        o = s[e];
                                    !1 !== o && (!0 === o && (o = r.clone(n.global.plugins[e])), i.push(t), a.push({
                                        plugin: t,
                                        options: o || {}
                                    }))
                                }
                ...
                e.exports = {
                    generators: {
                        ...
                        logarithmic: function (t, e) {
                            ...
                            do {
                                r.push(s), 10 === ++a && (a = 1, ++i), s = a * Math.pow(10, i)
                            } while (i < l || i === l && a < u);
                            var d = o(t.max, s);
                            return r.push(d), r
                        }
                    ...
                    t.Tooltip = a.extend({
                        ...
                        update: function (e) {
                            ...
                            if (g.length) {
                                ...
                                var S = [];
                                for (i = 0, n = g.length; i < n; ++i) S.push((a = g[i], s = void 0, l = void 0, void 0, void 0, s = a._xScale, l = a._yScale || a._scale, u = a._index, d = a._datasetIndex, {
                                ...
                                }), p.title = c.getTitle(S, v), p.beforeBody = c.getBeforeBody(S, v), p.body = c.getBody(S, v), p.afterBody = c.getAfterBody(S, v), p.footer = c.getFooter(S, v), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = S, b = function (t, e, i) {
                                    var n = t.x,
                                        a = t.y,
                                        r = t.caretSize,
                                        o = t.caretPadding,
                    ...
                    return {
                        ...
                        afterDatasetsUpdate: function (t, n) {
                            var r, l, u, d, c = (t.data.datasets || []).length,
                                h = n.propagate,
                                f = [];
                            for (l = 0; l < c; ++l) d = null, (u = (r = t.getDatasetMeta(l)).dataset) && u._model && u instanceof a.Line && (d = {
                            ...
                            if (v ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a)
                                if (s.font = f, v) {
                                    ...
                                    s.textAlign = "left", s.textBaseline = "top", r.each(t.legendItems, function (e, n) {
                                        ...
                                        m[m.length - 1] + a + i.padding >= t.width && (b += d + i.padding, m[m.length] = t.left), p[n] = {
                                            left: 0,
                                            top: 0,
                                            width: a,
                                            height: d
                ...
                e.exports = function (t) {
                    var e = t.Scale.extend({
                        ...
                        determineDataLimits: function () {
                            ...
                            x.length && (x = c(x).sort(d), v = Math.min(v, x[0]), m = Math.max(m, x[x.length - 1])), b.length && (b = c(b).sort(d), v = Math.min(v, b[0]), m = Math.max(m, b[b.length - 1])), v = p(g.min, h) || v, m = p(g.max, h) || m, v = v === s ? +n().startOf("day") : v, m = m === o ? +n().endOf("day") + 1 : m, h.min = Math.min(v, m), h.max = Math.max(v + 1, m), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {
                                data: b,
                                datasets: y,
                                labels: x
                            }
